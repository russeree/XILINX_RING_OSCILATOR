...
HD_PWD='/home/reese/xilinx_ring_oscilator/xilinx_ring_oscilator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ring_osc_mod.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ring_osc_mod.tcl
